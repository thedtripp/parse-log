...
class TestCookieGetter(unittest.TestCase):
    ...
    def setUp(self):
        """Instantiate the CookieGetter() and CSVFileReader() classes."""
    ...
    def test_read_file_to_list(self):
        ...
        self.assertEqual(
            self.csv_file_reader.read_file_to_list("cookie_log.csv"),
            [
                ("AtY0laUfhglK3lC7", datetime.date(2018, 12, 9)),
                ("SAZuXPGUrfbcn5UA", datetime.date(2018, 12, 9)),
                ("5UAVanZf6UtGyKVS", datetime.date(2018, 12, 9)),
                ("AtY0laUfhglK3lC7", datetime.date(2018, 12, 9)),
                ("SAZuXPGUrfbcn5UA", datetime.date(2018, 12, 8)),
                ("4sMM2LxV07bPJzwf", datetime.date(2018, 12, 8)),
                ("fbcn5UAVanZf6UtG", datetime.date(2018, 12, 8)),
                ("4sMM2LxV07bPJzwf", datetime.date(2018, 12, 7)),
            ],
        )
        with self.assertRaises(SystemExit):
            self.csv_file_reader.read_file_to_list("./test_files/empty_file.txt")
    ...
    def test_filter_list_on_dates(self):
        ...
        # Test with no dates.
        with self.assertRaises(SystemExit):
            self.cookie_getter.filter_list_on_dates(self.csv_file_reader.read_file_to_list("cookie_log.csv"), [])
        # Regular test case with cookies and a date.
        self.assertEqual(
            self.cookie_getter.filter_list_on_dates(
                self.csv_file_reader.read_file_to_list("cookie_log.csv"), [datetime.date(2018, 12, 8)]
            ),
    ...
    def test_get_cookie_frequencies(self):
        ...
        self.assertEqual(
            self.cookie_getter.get_cookie_frequencies(list_a),
            {
                "AtY0laUfhglK3lC7": 2,
                "SAZuXPGUrfbcn5UA": 2,
                "5UAVanZf6UtGyKVS": 1,
        ...
        self.assertEqual(
            self.cookie_getter.get_cookie_frequencies(list_b), {"abc": 3, "def": 2, "ghi": 2, "jkl": 1, "": 2}
        )
    ...
    def test_get_most_active_cookies(self):
        ...
        self.assertEqual(
            self.cookie_getter.get_most_active_cookies(list_a),
            ["AtY0laUfhglK3lC7", "SAZuXPGUrfbcn5UA", "4sMM2LxV07bPJzwf"],
        )
        ...
        self.assertEqual(
            self.cookie_getter.get_most_active_cookies(list_c),
            ["SAZuXPGUrfbcn5UA", "4sMM2LxV07bPJzwf", "fbcn5UAVanZf6UtG"],
        )
    ...
    def test_main(self):
        ...
        self.assertEqual(
            self.cookie_getter.main("cookie_log.csv", ["2018-12-08"]),
            ["SAZuXPGUrfbcn5UA", "4sMM2LxV07bPJzwf", "fbcn5UAVanZf6UtG"],
        )
        ...
        self.assertEqual(
            self.cookie_getter.main("cookie_log.csv", ["2018-12-09", "2018-12-08", "2018-12-07"]),
            ["AtY0laUfhglK3lC7", "SAZuXPGUrfbcn5UA", "4sMM2LxV07bPJzwf"],
        )
        # Test program in condition: File not found.
        with self.assertRaises(SystemExit):
            self.csv_file_reader.read_file_to_list("This_is_not_a_file.csv")
        # Test program in condition: Malformed data in log.
        with self.assertRaises(SystemExit):
            self.csv_file_reader.read_file_to_list("./test_files/malformed_cookie_log.csv")
        # Test program in condition: Empty log file.
        with self.assertRaises(SystemExit):
            self.csv_file_reader.read_file_to_list("./test_files/empty_file.txt")
        self.assertEqual(
            self.csv_file_reader.read_file_to_list("./test_files/problem_statement.txt"),
            [
                ("AtY0laUfhglK3lC7", datetime.date(2018, 12, 9)),
                ("SAZuXPGUrfbcn5UA", datetime.date(2018, 12, 9)),
                ("5UAVanZf6UtGyKVS", datetime.date(2018, 12, 9)),
